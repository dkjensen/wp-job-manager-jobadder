...
mix
    .js([
        `${devPath}/js/frontend.js`,
    ], `${distPath}/js/frontend.min.js`)
    .js([
        `${devPath}/js/admin.js`,
    ], `${distPath}/js/admin.min.js`);
...
// Compile SASS/CSS.
mix
    .sass(`${devPath}/css/admin.scss`, `${distPath}/css/admin.min.css`, sassConfig).options({
        postCss: [
            require('cssnano')({
                preset: ['default', {
                    discardComments: {
    ...
    .sass(`${devPath}/css/frontend.scss`, `${distPath}/css/frontend.min.css`, sassConfig).options({
        postCss: [
            require('cssnano')({
                preset: ['default', {
                    discardComments: {
